    ...
    return (
        <section className='bg-btn_color py-20 lg:px-16'>
            <div className=' lg:flex   gap-28'>
                ...
                <div className='lg:w-1/3'>
                    <h3 className='text-white text-xl font-semibold my-5'>Contact Info</h3>
                    <div className='text-white flex py-3 gap-5 items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-300 text-sm'>72 Mossadak St,Eldokki,Giza, 12311,Egypt</p>
                        </div>
                    ...
                    <div className='text-white flex py-3 gap-5 items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-300 text-sm'>sales@gmail.com</p>
                        </div>
                    ...
                    <div className='text-white flex py-3 gap-5 items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-300 text-sm'>+20 23 33 83 657 / +20 23 33 83 659</p>
                        </div>
