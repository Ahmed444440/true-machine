                    ...
                    {Product.map((items, index) => (
                            <div key={index} className="shadow-md rounded-md">
                                <div className="">
                                    ...
                                    <div className='my-8'>
                                        <Link href={`/`} className={'bg-transparent  text-primary_color rounded-md border-solid border-primary_color border-[1px] hover:bg-primary_color hover:ease-in-out hover:text-white hover:delay-200  py-3 px-7'} >
                                            Read More
                                        </Link>
                                    </div>
                                    </div>
