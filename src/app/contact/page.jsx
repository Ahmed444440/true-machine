                ...
                <div className='lg:w-1/2'>
                    ...
                    <div>
                        <div className='text-white flex py-3 gap-5 items-start'>
                            ...
                            <div>
                                <p className='text-gray-600 font-semibold '>72 Mossadak St,Eldokki,Giza, 12311,Egypt</p>
                            </div>
                        ...
                        <div className='text-white flex py-3 gap-5 items-start'>
                            ...
                            <div>
                                <p className='text-gray-600 font-semibold '>sales@gmail.com</p>
                            </div>
                        ...
                        <div className='text-white flex py-3 gap-5 items-start'>
                            ...
                            <div>
                                ...
                                <p className='text-gray-600 font-semibold '>+20 23 33 83 657 / +20 23 33 83 659</p>
                            </div>
